...
public class TestCreateBooking extends BaseTest {
    ...
    @Test(groups = "reg", priority = 1)
    @Owner("Vinod")
    @Description("TC#4 - Verify that the Booking is not Created")
    ...
    @Test(groups = "reg", priority = 1)
    @Owner("Vinod")
    @Description("TC#5 - Verify that the Booking can be Created, When Payload is CHINESE")
    ...
    @Test(groups = "reg", priority = 1)
    @Owner("Promode")
    @Description("TC#6 - Verify that the Booking can be Created, When Payload is RANDOM")
